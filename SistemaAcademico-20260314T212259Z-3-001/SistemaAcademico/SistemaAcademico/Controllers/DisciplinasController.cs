...
namespace SistemaAcademico.controllers
{
    public class DisciplinasController : Controller
    {
        ...
        {
            ViewData["CursoId"] = new SelectList(_context.Cursos, "CursoId", "Nome"); // O Primeiro parâmetro é o que o banco armazena o segundo é o que aparece no site.
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] // Evita ataques maliciosos básicos
        public async Task<IActionResult> Create([Bind("Nome,Semestre,CursoId")] Disciplina disciplina)
            // Bind é como se fosse um fiscal o DisciplinaId pode ser tirado do create por que ele pega o Id do DB.
        {
        ...
        // Isso é quando eu vou mostrar pro usuário.
